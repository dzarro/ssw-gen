...
goesninstr=ssw_instruments(/goesn)
goesrinstr=ssw_instruments(/goesr)
...
mmap=strupcase([replicate('soho',n_elements(sinstr)),$
                ...
                replicate('goesn',n_elements(goesninstr)),    $
                replicate('goesr',n_elements(goesrinstr)),    $
...
goesn=keyword_set(goesn)
goesr=keyword_set(goesr)
...
if goesn   then instr=[instr,goesninstr]
if goesr   then instr=[instr,goesrinstr]
