...
;
;               Z_OUT   = Third dimension of output data, for use when not
;                         included in the WCS structure.  Units depend on the
;                         input length units.  Not always calculated if the
;                         input Z array is omitted.
;
...
;               Version 2, 30-Nov-2017, WTT, added keyword Z_OUT
;
; Contact     :	WTHOMPSON
;-
;
pro wcs_convert_to_coord, wcs, coord, type, x_in, y_in, z_in, $
                          ...
                          get_pixel=get_pixel, z_out=z_out, _extra=_extra
on_error, 2
;
