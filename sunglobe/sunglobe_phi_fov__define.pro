...
;
; Name        :	SUNGLOBE_PHI_FOV__DEFINE
;
; Purpose     :	Object graphics for PHI field-of-view in SUNGLOBE
;
; Category    :	Object graphics, 3D, Planning, PHI
;
; Explanation : Creates a field-of-view graphics object for the PHI instrument
;               high resolution channel for use within the SUNGLOBE program.
;               By default, the field-of-view is defined to be 1008x1008 arc
;               seconds (16.8 arc minutes).
;
; Syntax      :	To initially create:
;                       oPHI = OBJ_NEW('sunglobe_phi_fov', sstate=sstate)
;
;               To retrieve a property value:
;                       oPHI -> GetProperty, property=property
;
;               To set a property value:
;                       oPHI -> SetProperty, property=property
;
...
;               SETPROPERTY methods.
;
;               XSIZE   = Size in arcsec in X direction.  (Default=1008)
;
;               YSIZE   = Size in arcsec in Y direction.  (Default=1008)
;
...
;-
;
function sunglobe_phi_fov::init, sstate=sstate, xsize=xsize, ysize=ysize, $
...
pro sunglobe_phi_fov__define
struct = {sunglobe_phi_fov, $
          INHERITS IDLgrModel, $
          psstate: ptr_new(), $
          xsize: 0, $
          ysize: 1, $
